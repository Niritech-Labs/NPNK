...
NB_MODULE(npnuklear, m) {
    ...
    m.def("nk_init_default", &nk_init_default);

    m.def("nk_init_fixed", &nk_init_fixed);

    m.def("nk_init_custom", &nk_init_custom);

    m.def("nk_clear", &nk_clear);

    m.def("nk_free", &nk_free);

    m.def("nk_input_begin", &nk_input_begin);

    m.def("nk_input_motion", &nk_input_motion);

    m.def("nk_input_key", &nk_input_key);

    m.def("nk_input_button", &nk_input_button);

    m.def("nk_input_scroll", &nk_input_scroll);

    m.def("nk_input_char", &nk_input_char);

    m.def("nk_input_glyph", &nk_input_glyph);

    m.def("nk_input_unicode", &nk_input_unicode);

    m.def("nk_input_end", &nk_input_end);

    m.def("nk__begin", &nk__begin, nb::rv_policy::reference);

    m.def("nk__next", &nk__next, nb::rv_policy::reference);

    m.def("nk_convert", &nk_convert);

    m.def("nk__draw_begin", &nk__draw_begin, nb::rv_policy::reference);

    m.def("nk__draw_end", &nk__draw_end, nb::rv_policy::reference);

    m.def("nk__draw_next", &nk__draw_next, nb::rv_policy::reference);

    m.def("nk_begin", &nk_begin);

    m.def("nk_begin_titled", &nk_begin_titled);

    m.def("nk_end", &nk_end);

    m.def("nk_window_get_bounds", &nk_window_get_bounds);

    m.def("nk_window_get_position", &nk_window_get_position);

    m.def("nk_window_get_size", &nk_window_get_size);

    m.def("nk_window_get_width", &nk_window_get_width);

    m.def("nk_window_get_height", &nk_window_get_height);

    m.def("nk_window_get_panel", &nk_window_get_panel, nb::rv_policy::reference);

    m.def("nk_window_get_content_region", &nk_window_get_content_region);

    m.def("nk_window_get_content_region_min", &nk_window_get_content_region_min);

    m.def("nk_window_get_content_region_max", &nk_window_get_content_region_max);

    m.def("nk_window_get_content_region_size", &nk_window_get_content_region_size);

    m.def("nk_window_get_canvas", &nk_window_get_canvas, nb::rv_policy::reference);

    m.def("nk_window_get_scroll", &nk_window_get_scroll);

    m.def("nk_window_has_focus", &nk_window_has_focus);

    m.def("nk_window_is_hovered", &nk_window_is_hovered);

    m.def("nk_window_is_collapsed", &nk_window_is_collapsed);

    m.def("nk_window_is_closed", &nk_window_is_closed);

    m.def("nk_window_is_hidden", &nk_window_is_hidden);

    m.def("nk_window_is_active", &nk_window_is_active);

    m.def("nk_window_is_any_hovered", &nk_window_is_any_hovered);

    m.def("nk_item_is_any_active", &nk_item_is_any_active);

    m.def("nk_window_set_bounds", &nk_window_set_bounds);

    m.def("nk_window_set_position", &nk_window_set_position);

    m.def("nk_window_set_size", &nk_window_set_size);

    m.def("nk_window_set_focus", &nk_window_set_focus);

    m.def("nk_window_set_scroll", &nk_window_set_scroll);

    m.def("nk_window_close", &nk_window_close);

    m.def("nk_window_collapse", &nk_window_collapse);

    m.def("nk_window_collapse_if", &nk_window_collapse_if);

    m.def("nk_window_show", &nk_window_show);

    m.def("nk_window_show_if", &nk_window_show_if);

    m.def("nk_rule_horizontal", &nk_rule_horizontal);

    m.def("nk_layout_set_min_row_height", &nk_layout_set_min_row_height);

    m.def("nk_layout_reset_min_row_height", &nk_layout_reset_min_row_height);

    m.def("nk_layout_widget_bounds", &nk_layout_widget_bounds);

    m.def("nk_layout_ratio_from_pixel", &nk_layout_ratio_from_pixel);

    m.def("nk_layout_row_dynamic", &nk_layout_row_dynamic);

    m.def("nk_layout_row_static", &nk_layout_row_static);

    m.def("nk_layout_row_begin", &nk_layout_row_begin);

    m.def("nk_layout_row_push", &nk_layout_row_push);

    m.def("nk_layout_row_end", &nk_layout_row_end);

    m.def("nk_layout_row", &nk_layout_row);

    m.def("nk_layout_row_template_begin", &nk_layout_row_template_begin);

    m.def("nk_layout_row_template_push_dynamic", &nk_layout_row_template_push_dynamic);

    m.def("nk_layout_row_template_push_variable", &nk_layout_row_template_push_variable);

    m.def("nk_layout_row_template_push_static", &nk_layout_row_template_push_static);

    m.def("nk_layout_row_template_end", &nk_layout_row_template_end);

    m.def("nk_layout_space_begin", &nk_layout_space_begin);

    m.def("nk_layout_space_push", &nk_layout_space_push);

    m.def("nk_layout_space_end", &nk_layout_space_end);

    m.def("nk_layout_space_bounds", &nk_layout_space_bounds);

    m.def("nk_layout_space_to_screen", &nk_layout_space_to_screen);

    m.def("nk_layout_space_to_local", &nk_layout_space_to_local);

    m.def("nk_layout_space_rect_to_screen", &nk_layout_space_rect_to_screen);

    m.def("nk_layout_space_rect_to_local", &nk_layout_space_rect_to_local);

    m.def("nk_spacer", &nk_spacer);

    m.def("nk_group_begin", &nk_group_begin);

    m.def("nk_group_begin_titled", &nk_group_begin_titled);

    m.def("nk_group_end", &nk_group_end);

    m.def("nk_group_scrolled_offset_begin", &nk_group_scrolled_offset_begin);

    m.def("nk_group_scrolled_begin", &nk_group_scrolled_begin);

    m.def("nk_group_scrolled_end", &nk_group_scrolled_end);

    m.def("nk_group_get_scroll", &nk_group_get_scroll);

    m.def("nk_group_set_scroll", &nk_group_set_scroll);

    m.def("nk_tree_push_hashed", &nk_tree_push_hashed);

    m.def("nk_tree_image_push_hashed", &nk_tree_image_push_hashed);

    m.def("nk_tree_pop", &nk_tree_pop);

    m.def("nk_tree_state_push", &nk_tree_state_push);

    m.def("nk_tree_state_image_push", &nk_tree_state_image_push);

    m.def("nk_tree_state_pop", &nk_tree_state_pop);

    m.def("nk_tree_element_push_hashed", &nk_tree_element_push_hashed);

    m.def("nk_tree_element_image_push_hashed", &nk_tree_element_image_push_hashed);

    m.def("nk_tree_element_pop", &nk_tree_element_pop);

    m.def("nk_list_view_begin", &nk_list_view_begin);

    m.def("nk_list_view_end", &nk_list_view_end);

    m.def("nk_widget", &nk_widget);

    m.def("nk_widget_fitting", &nk_widget_fitting);

    m.def("nk_widget_bounds", &nk_widget_bounds);

    m.def("nk_widget_position", &nk_widget_position);

    m.def("nk_widget_size", &nk_widget_size);

    m.def("nk_widget_width", &nk_widget_width);

    m.def("nk_widget_height", &nk_widget_height);

    m.def("nk_widget_is_hovered", &nk_widget_is_hovered);

    m.def("nk_widget_is_mouse_clicked", &nk_widget_is_mouse_clicked);

    m.def("nk_widget_has_mouse_click_down", &nk_widget_has_mouse_click_down);

    m.def("nk_spacing", &nk_spacing);

    m.def("nk_widget_disable_begin", &nk_widget_disable_begin);

    m.def("nk_widget_disable_end", &nk_widget_disable_end);

    m.def("nk_text", &nk_text);

    m.def("nk_text_colored", &nk_text_colored);

    m.def("nk_text_wrap", &nk_text_wrap);

    m.def("nk_text_wrap_colored", &nk_text_wrap_colored);

    m.def("nk_label", &nk_label);

    m.def("nk_label_colored", &nk_label_colored);

    m.def("nk_label_wrap", &nk_label_wrap);

    m.def("nk_label_colored_wrap", &nk_label_colored_wrap);

    m.def("nk_image", &nk_image);

    m.def("nk_image_color", &nk_image_color);

    m.def("nk_button_text", &nk_button_text);

    m.def("nk_button_label", &nk_button_label);

    m.def("nk_button_color", &nk_button_color);

    m.def("nk_button_symbol", &nk_button_symbol);

    m.def("nk_button_image", &nk_button_image);

    m.def("nk_button_symbol_label", &nk_button_symbol_label);

    m.def("nk_button_symbol_text", &nk_button_symbol_text);

    m.def("nk_button_image_label", &nk_button_image_label);

    m.def("nk_button_image_text", &nk_button_image_text);

    m.def("nk_button_text_styled", &nk_button_text_styled);

    m.def("nk_button_label_styled", &nk_button_label_styled);

    m.def("nk_button_symbol_styled", &nk_button_symbol_styled);

    m.def("nk_button_image_styled", &nk_button_image_styled);

    m.def("nk_button_symbol_text_styled", &nk_button_symbol_text_styled);

    m.def("nk_button_symbol_label_styled", &nk_button_symbol_label_styled);

    m.def("nk_button_image_label_styled", &nk_button_image_label_styled);

    m.def("nk_button_image_text_styled", &nk_button_image_text_styled);

    m.def("nk_button_set_behavior", &nk_button_set_behavior);

    m.def("nk_button_push_behavior", &nk_button_push_behavior);

    m.def("nk_button_pop_behavior", &nk_button_pop_behavior);

    m.def("nk_check_label", &nk_check_label);

    m.def("nk_check_text", &nk_check_text);

    m.def("nk_check_text_align", &nk_check_text_align);

    m.def("nk_check_flags_label", &nk_check_flags_label);

    m.def("nk_check_flags_text", &nk_check_flags_text);

    m.def("nk_checkbox_label", &nk_checkbox_label);

    m.def("nk_checkbox_label_align", &nk_checkbox_label_align);

    m.def("nk_checkbox_text", &nk_checkbox_text);

    m.def("nk_checkbox_text_align", &nk_checkbox_text_align);

    m.def("nk_checkbox_flags_label", &nk_checkbox_flags_label);

    m.def("nk_checkbox_flags_text", &nk_checkbox_flags_text);

    m.def("nk_radio_label", &nk_radio_label);

    m.def("nk_radio_label_align", &nk_radio_label_align);

    m.def("nk_radio_text", &nk_radio_text);

    m.def("nk_radio_text_align", &nk_radio_text_align);

    m.def("nk_option_label", &nk_option_label);

    m.def("nk_option_label_align", &nk_option_label_align);

    m.def("nk_option_text", &nk_option_text);

    m.def("nk_option_text_align", &nk_option_text_align);

    m.def("nk_selectable_label", &nk_selectable_label);

    m.def("nk_selectable_text", &nk_selectable_text);

    m.def("nk_selectable_image_label", &nk_selectable_image_label);

    m.def("nk_selectable_image_text", &nk_selectable_image_text);

    m.def("nk_selectable_symbol_label", &nk_selectable_symbol_label);

    m.def("nk_selectable_symbol_text", &nk_selectable_symbol_text);

    m.def("nk_select_label", &nk_select_label);

    m.def("nk_select_text", &nk_select_text);

    m.def("nk_select_image_label", &nk_select_image_label);

    m.def("nk_select_image_text", &nk_select_image_text);

    m.def("nk_select_symbol_label", &nk_select_symbol_label);

    m.def("nk_select_symbol_text", &nk_select_symbol_text);

    m.def("nk_slide_float", &nk_slide_float);

    m.def("nk_slide_int", &nk_slide_int);

    m.def("nk_slider_float", &nk_slider_float);

    m.def("nk_slider_int", &nk_slider_int);

    m.def("nk_knob_float", &nk_knob_float);

    m.def("nk_knob_int", &nk_knob_int);

    m.def("nk_progress", &nk_progress);

    m.def("nk_prog", &nk_prog);

    m.def("nk_color_picker", &nk_color_picker);

    m.def("nk_color_pick", &nk_color_pick);

    m.def("nk_property_int", &nk_property_int);

    m.def("nk_property_float", &nk_property_float);

    m.def("nk_property_double", &nk_property_double);

    m.def("nk_propertyi", &nk_propertyi);

    m.def("nk_propertyf", &nk_propertyf);

    m.def("nk_propertyd", &nk_propertyd);

    m.def("nk_edit_buffer", &nk_edit_buffer);

    m.def("nk_edit_focus", &nk_edit_focus);

    m.def("nk_edit_unfocus", &nk_edit_unfocus);

    m.def("nk_chart_begin", &nk_chart_begin);

    m.def("nk_chart_begin_colored", &nk_chart_begin_colored);

    m.def("nk_chart_add_slot", &nk_chart_add_slot);

    m.def("nk_chart_add_slot_colored", &nk_chart_add_slot_colored);

    m.def("nk_chart_push", &nk_chart_push);

    m.def("nk_chart_push_slot", &nk_chart_push_slot);

    m.def("nk_chart_end", &nk_chart_end);

    m.def("nk_plot", &nk_plot);

    m.def("nk_plot_function", &nk_plot_function);

    m.def("nk_popup_begin", &nk_popup_begin);

    m.def("nk_popup_close", &nk_popup_close);

    m.def("nk_popup_end", &nk_popup_end);

    m.def("nk_popup_get_scroll", &nk_popup_get_scroll);

    m.def("nk_popup_set_scroll", &nk_popup_set_scroll);

    m.def("nk_combo_separator", &nk_combo_separator);

    m.def("nk_combo_string", &nk_combo_string);

    m.def("nk_combo_callback", &nk_combo_callback);

    m.def("nk_combobox_string", &nk_combobox_string);

    m.def("nk_combobox_separator", &nk_combobox_separator);

    m.def("nk_combobox_callback", &nk_combobox_callback);

    m.def("nk_combo_begin_text", &nk_combo_begin_text);

    m.def("nk_combo_begin_label", &nk_combo_begin_label);

    m.def("nk_combo_begin_color", &nk_combo_begin_color);

    m.def("nk_combo_begin_symbol", &nk_combo_begin_symbol);

    m.def("nk_combo_begin_symbol_label", &nk_combo_begin_symbol_label);

    m.def("nk_combo_begin_symbol_text", &nk_combo_begin_symbol_text);

    m.def("nk_combo_begin_image", &nk_combo_begin_image);

    m.def("nk_combo_begin_image_label", &nk_combo_begin_image_label);

    m.def("nk_combo_begin_image_text", &nk_combo_begin_image_text);

    m.def("nk_combo_item_label", &nk_combo_item_label);

    m.def("nk_combo_item_text", &nk_combo_item_text);

    m.def("nk_combo_item_image_label", &nk_combo_item_image_label);

    m.def("nk_combo_item_image_text", &nk_combo_item_image_text);

    m.def("nk_combo_item_symbol_label", &nk_combo_item_symbol_label);

    m.def("nk_combo_item_symbol_text", &nk_combo_item_symbol_text);

    m.def("nk_combo_close", &nk_combo_close);

    m.def("nk_combo_end", &nk_combo_end);

    m.def("nk_contextual_begin", &nk_contextual_begin);

    m.def("nk_contextual_item_text", &nk_contextual_item_text);

    m.def("nk_contextual_item_label", &nk_contextual_item_label);

    m.def("nk_contextual_item_image_label", &nk_contextual_item_image_label);

    m.def("nk_contextual_item_image_text", &nk_contextual_item_image_text);

    m.def("nk_contextual_item_symbol_label", &nk_contextual_item_symbol_label);

    m.def("nk_contextual_item_symbol_text", &nk_contextual_item_symbol_text);

    m.def("nk_contextual_close", &nk_contextual_close);

    m.def("nk_contextual_end", &nk_contextual_end);

    m.def("nk_tooltip", &nk_tooltip);

    m.def("nk_tooltip_offset", &nk_tooltip_offset);

    m.def("nk_tooltip_begin", &nk_tooltip_begin);

    m.def("nk_tooltip_begin_offset", &nk_tooltip_begin_offset);

    m.def("nk_tooltip_end", &nk_tooltip_end);

    m.def("nk_menubar_begin", &nk_menubar_begin);

    m.def("nk_menubar_end", &nk_menubar_end);

    m.def("nk_menu_begin_text", &nk_menu_begin_text);

    m.def("nk_menu_begin_label", &nk_menu_begin_label);

    m.def("nk_menu_begin_image", &nk_menu_begin_image);

    m.def("nk_menu_begin_image_text", &nk_menu_begin_image_text);

    m.def("nk_menu_begin_image_label", &nk_menu_begin_image_label);

    m.def("nk_menu_begin_symbol", &nk_menu_begin_symbol);

    m.def("nk_menu_begin_symbol_text", &nk_menu_begin_symbol_text);

    m.def("nk_menu_begin_symbol_label", &nk_menu_begin_symbol_label);

    m.def("nk_menu_item_text", &nk_menu_item_text);

    m.def("nk_menu_item_label", &nk_menu_item_label);

    m.def("nk_menu_item_image_label", &nk_menu_item_image_label);

    m.def("nk_menu_item_image_text", &nk_menu_item_image_text);

    m.def("nk_menu_item_symbol_text", &nk_menu_item_symbol_text);

    m.def("nk_menu_item_symbol_label", &nk_menu_item_symbol_label);

    m.def("nk_menu_close", &nk_menu_close);

    m.def("nk_menu_end", &nk_menu_end);

    m.def("nk_style_default", &nk_style_default);

    m.def("nk_style_from_table", &nk_style_from_table);

    m.def("nk_style_load_cursor", &nk_style_load_cursor);

    m.def("nk_style_load_all_cursors", &nk_style_load_all_cursors);

    m.def("nk_style_get_color_by_name", &nk_style_get_color_by_name, nb::rv_policy::reference);

    m.def("nk_style_set_font", &nk_style_set_font);

    m.def("nk_style_set_cursor", &nk_style_set_cursor);

    m.def("nk_style_show_cursor", &nk_style_show_cursor);

    m.def("nk_style_hide_cursor", &nk_style_hide_cursor);

    m.def("nk_style_push_font", &nk_style_push_font);

    m.def("nk_style_push_float", &nk_style_push_float);

    m.def("nk_style_push_vec2", &nk_style_push_vec2);

    m.def("nk_style_push_style_item", &nk_style_push_style_item);

    m.def("nk_style_push_flags", &nk_style_push_flags);

    m.def("nk_style_push_color", &nk_style_push_color);

    m.def("nk_style_pop_font", &nk_style_pop_font);

    m.def("nk_style_pop_float", &nk_style_pop_float);

    m.def("nk_style_pop_vec2", &nk_style_pop_vec2);

    m.def("nk_style_pop_style_item", &nk_style_pop_style_item);

    m.def("nk_style_pop_flags", &nk_style_pop_flags);

    m.def("nk_style_pop_color", &nk_style_pop_color);

    m.def("nk_rgb", &nk_rgb);

    m.def("nk_rgb_iv", &nk_rgb_iv);

    m.def("nk_rgb_bv", &nk_rgb_bv);

    m.def("nk_rgb_f", &nk_rgb_f);

    m.def("nk_rgb_fv", &nk_rgb_fv);

    m.def("nk_rgb_cf", &nk_rgb_cf);

    m.def("nk_rgb_hex", &nk_rgb_hex);

    m.def("nk_rgb_factor", &nk_rgb_factor);

    m.def("nk_rgba", &nk_rgba);

    m.def("nk_rgba_u32", &nk_rgba_u32);

    m.def("nk_rgba_iv", &nk_rgba_iv);

    m.def("nk_rgba_bv", &nk_rgba_bv);

    m.def("nk_rgba_f", &nk_rgba_f);

    m.def("nk_rgba_fv", &nk_rgba_fv);

    m.def("nk_rgba_cf", &nk_rgba_cf);

    m.def("nk_rgba_hex", &nk_rgba_hex);

    m.def("nk_hsva_colorf", &nk_hsva_colorf);

    m.def("nk_hsva_colorfv", &nk_hsva_colorfv);

    m.def("nk_colorf_hsva_f", &nk_colorf_hsva_f);

    m.def("nk_colorf_hsva_fv", &nk_colorf_hsva_fv);

    m.def("nk_hsv", &nk_hsv);

    m.def("nk_hsv_iv", &nk_hsv_iv);

    m.def("nk_hsv_bv", &nk_hsv_bv);

    m.def("nk_hsv_f", &nk_hsv_f);

    m.def("nk_hsv_fv", &nk_hsv_fv);

    m.def("nk_hsva", &nk_hsva);

    m.def("nk_hsva_iv", &nk_hsva_iv);

    m.def("nk_hsva_bv", &nk_hsva_bv);

    m.def("nk_hsva_f", &nk_hsva_f);

    m.def("nk_hsva_fv", &nk_hsva_fv);

    m.def("nk_color_f", &nk_color_f);

    m.def("nk_color_fv", &nk_color_fv);

    m.def("nk_color_cf", &nk_color_cf);

    m.def("nk_color_d", &nk_color_d);

    m.def("nk_color_dv", &nk_color_dv);

    m.def("nk_color_u32", &nk_color_u32);

    m.def("nk_color_hsv_i", &nk_color_hsv_i);

    m.def("nk_color_hsv_b", &nk_color_hsv_b);

    m.def("nk_color_hsv_iv", &nk_color_hsv_iv);

    m.def("nk_color_hsv_bv", &nk_color_hsv_bv);

    m.def("nk_color_hsv_f", &nk_color_hsv_f);

    m.def("nk_color_hsv_fv", &nk_color_hsv_fv);

    m.def("nk_color_hsva_i", &nk_color_hsva_i);

    m.def("nk_color_hsva_b", &nk_color_hsva_b);

    m.def("nk_color_hsva_iv", &nk_color_hsva_iv);

    m.def("nk_color_hsva_bv", &nk_color_hsva_bv);

    m.def("nk_color_hsva_f", &nk_color_hsva_f);

    m.def("nk_color_hsva_fv", &nk_color_hsva_fv);

    m.def("nk_handle_ptr", &nk_handle_ptr);

    m.def("nk_handle_id", &nk_handle_id);

    m.def("nk_image_handle", &nk_image_handle);

    m.def("nk_image_ptr", &nk_image_ptr);

    m.def("nk_image_id", &nk_image_id);

    m.def("nk_image_is_subimage", &nk_image_is_subimage);

    m.def("nk_subimage_ptr", &nk_subimage_ptr);

    m.def("nk_subimage_id", &nk_subimage_id);

    m.def("nk_subimage_handle", &nk_subimage_handle);

    m.def("nk_nine_slice_handle", &nk_nine_slice_handle);

    m.def("nk_nine_slice_ptr", &nk_nine_slice_ptr);

    m.def("nk_nine_slice_id", &nk_nine_slice_id);

    m.def("nk_nine_slice_is_sub9slice", &nk_nine_slice_is_sub9slice);

    m.def("nk_sub9slice_ptr", &nk_sub9slice_ptr);

    m.def("nk_sub9slice_id", &nk_sub9slice_id);

    m.def("nk_sub9slice_handle", &nk_sub9slice_handle);

    m.def("nk_murmur_hash", &nk_murmur_hash);

    m.def("nk_triangle_from_direction", &nk_triangle_from_direction);

    m.def("nk_vec2", &nk_vec2);

    m.def("nk_vec2i", &nk_vec2i);

    m.def("nk_vec2v", &nk_vec2v);

    m.def("nk_vec2iv", &nk_vec2iv);

    m.def("nk_get_null_rect", &nk_get_null_rect);

    m.def("nk_rect", &nk_rect);

    m.def("nk_recti", &nk_recti);

    m.def("nk_recta", &nk_recta);

    m.def("nk_rectv", &nk_rectv);

    m.def("nk_rectiv", &nk_rectiv);

    m.def("nk_rect_pos", &nk_rect_pos);

    m.def("nk_rect_size", &nk_rect_size);

    m.def("nk_strlen", &nk_strlen);

    m.def("nk_stricmp", &nk_stricmp);

    m.def("nk_stricmpn", &nk_stricmpn);

    m.def("nk_strfilter", &nk_strfilter);

    m.def("nk_strmatch_fuzzy_string", &nk_strmatch_fuzzy_string);

    m.def("nk_strmatch_fuzzy_text", &nk_strmatch_fuzzy_text);

    m.def("nk_font_atlas_init_default", &nk_font_atlas_init_default);

    m.def("nk_font_atlas_begin", &nk_font_atlas_begin);

    m.def("nk_font_config", &nk_font_config);

    m.def("nk_font_atlas_add_default", &nk_font_atlas_add_default, nb::rv_policy::reference);

    m.def("nk_font_atlas_add_from_memory", &nk_font_atlas_add_from_memory, nb::rv_policy::reference);

    m.def("nk_font_atlas_add_from_file", &nk_font_atlas_add_from_file, nb::rv_policy::reference);

    m.def("nk_font_atlas_add_compressed_base85", &nk_font_atlas_add_compressed_base85, nb::rv_policy::reference);

    m.def("nk_font_atlas_bake", as_capsule(&nk_font_atlas_bake));

    m.def("nk_font_atlas_end", &nk_font_atlas_end);

    m.def("nk_font_find_glyph", &nk_font_find_glyph, nb::rv_policy::reference);

    m.def("nk_font_atlas_cleanup", &nk_font_atlas_cleanup);

    m.def("nk_font_atlas_clear", &nk_font_atlas_clear);

    m.def("nk_buffer_init_default", &nk_buffer_init_default);

    m.def("nk_buffer_init_fixed", &nk_buffer_init_fixed);

    m.def("nk_buffer_info", &nk_buffer_info);

    m.def("nk_buffer_push", &nk_buffer_push);

    m.def("nk_buffer_mark", &nk_buffer_mark);

    m.def("nk_buffer_reset", &nk_buffer_reset);

    m.def("nk_buffer_clear", &nk_buffer_clear);

    m.def("nk_buffer_free", &nk_buffer_free);

    m.def("nk_buffer_total", &nk_buffer_total);

    m.def("nk_str_init_default", &nk_str_init_default);

    m.def("nk_str_init_fixed", &nk_str_init_fixed);

    m.def("nk_str_clear", &nk_str_clear);

    m.def("nk_str_free", &nk_str_free);

    m.def("nk_str_append_text_char", &nk_str_append_text_char);

    m.def("nk_str_append_str_char", &nk_str_append_str_char);

    m.def("nk_str_append_text_utf8", &nk_str_append_text_utf8);

    m.def("nk_str_append_str_utf8", &nk_str_append_str_utf8);

    m.def("nk_str_append_text_runes", &nk_str_append_text_runes);

    m.def("nk_str_append_str_runes", &nk_str_append_str_runes);

    m.def("nk_str_insert_at_char", &nk_str_insert_at_char);

    m.def("nk_str_insert_at_rune", &nk_str_insert_at_rune);

    m.def("nk_str_insert_text_char", &nk_str_insert_text_char);

    m.def("nk_str_insert_str_char", &nk_str_insert_str_char);

    m.def("nk_str_insert_text_utf8", &nk_str_insert_text_utf8);

    m.def("nk_str_insert_str_utf8", &nk_str_insert_str_utf8);

    m.def("nk_str_insert_text_runes", &nk_str_insert_text_runes);

    m.def("nk_str_insert_str_runes", &nk_str_insert_str_runes);

    m.def("nk_str_remove_chars", &nk_str_remove_chars);

    m.def("nk_str_remove_runes", &nk_str_remove_runes);

    m.def("nk_str_delete_chars", &nk_str_delete_chars);

    m.def("nk_str_delete_runes", &nk_str_delete_runes);

    m.def("nk_str_rune_at", &nk_str_rune_at);

    m.def("nk_str_len", &nk_str_len);

    m.def("nk_str_len_char", &nk_str_len_char);

    m.def("nk_filter_default", &nk_filter_default);

    m.def("nk_filter_ascii", &nk_filter_ascii);

    m.def("nk_filter_float", &nk_filter_float);

    m.def("nk_filter_decimal", &nk_filter_decimal);

    m.def("nk_filter_hex", &nk_filter_hex);

    m.def("nk_filter_oct", &nk_filter_oct);

    m.def("nk_filter_binary", &nk_filter_binary);

    m.def("nk_textedit_init_default", &nk_textedit_init_default);

    m.def("nk_textedit_init_fixed", &nk_textedit_init_fixed);

    m.def("nk_textedit_free", &nk_textedit_free);

    m.def("nk_textedit_text", &nk_textedit_text);

    m.def("nk_textedit_delete", &nk_textedit_delete);

    m.def("nk_textedit_delete_selection", &nk_textedit_delete_selection);

    m.def("nk_textedit_select_all", &nk_textedit_select_all);

    m.def("nk_textedit_cut", &nk_textedit_cut);

    m.def("nk_textedit_paste", &nk_textedit_paste);

    m.def("nk_textedit_undo", &nk_textedit_undo);

    m.def("nk_textedit_redo", &nk_textedit_redo);

    m.def("nk_stroke_line", &nk_stroke_line);

    m.def("nk_stroke_curve", &nk_stroke_curve);

    m.def("nk_stroke_rect", &nk_stroke_rect);

    m.def("nk_stroke_circle", &nk_stroke_circle);

    m.def("nk_stroke_arc", &nk_stroke_arc);

    m.def("nk_stroke_triangle", &nk_stroke_triangle);

    m.def("nk_stroke_polyline", &nk_stroke_polyline);

    m.def("nk_stroke_polygon", &nk_stroke_polygon);

    m.def("nk_fill_rect", &nk_fill_rect);

    m.def("nk_fill_rect_multi_color", &nk_fill_rect_multi_color);

    m.def("nk_fill_circle", &nk_fill_circle);

    m.def("nk_fill_arc", &nk_fill_arc);

    m.def("nk_fill_triangle", &nk_fill_triangle);

    m.def("nk_fill_polygon", &nk_fill_polygon);

    m.def("nk_draw_image", &nk_draw_image);

    m.def("nk_draw_nine_slice", &nk_draw_nine_slice);

    m.def("nk_draw_text", &nk_draw_text);

    m.def("nk_push_scissor", &nk_push_scissor);

    m.def("nk_input_has_mouse_click", &nk_input_has_mouse_click);

    m.def("nk_input_has_mouse_click_in_rect", &nk_input_has_mouse_click_in_rect);

    m.def("nk_input_has_mouse_click_in_button_rect", &nk_input_has_mouse_click_in_button_rect);

    m.def("nk_input_has_mouse_click_down_in_rect", &nk_input_has_mouse_click_down_in_rect);

    m.def("nk_input_is_mouse_click_in_rect", &nk_input_is_mouse_click_in_rect);

    m.def("nk_input_is_mouse_click_down_in_rect", &nk_input_is_mouse_click_down_in_rect);

    m.def("nk_input_any_mouse_click_in_rect", &nk_input_any_mouse_click_in_rect);

    m.def("nk_input_is_mouse_prev_hovering_rect", &nk_input_is_mouse_prev_hovering_rect);

    m.def("nk_input_is_mouse_hovering_rect", &nk_input_is_mouse_hovering_rect);

    m.def("nk_input_is_mouse_moved", &nk_input_is_mouse_moved);

    m.def("nk_input_mouse_clicked", &nk_input_mouse_clicked);

    m.def("nk_input_is_mouse_down", &nk_input_is_mouse_down);

    m.def("nk_input_is_mouse_pressed", &nk_input_is_mouse_pressed);

    m.def("nk_input_is_mouse_released", &nk_input_is_mouse_released);

    m.def("nk_input_is_key_pressed", &nk_input_is_key_pressed);

    m.def("nk_input_is_key_released", &nk_input_is_key_released);

    m.def("nk_input_is_key_down", &nk_input_is_key_down);

    m.def("nk_draw_list_init", &nk_draw_list_init);

    m.def("nk_draw_list_setup", &nk_draw_list_setup);

    m.def("nk__draw_list_begin", &nk__draw_list_begin, nb::rv_policy::reference);

    m.def("nk__draw_list_next", &nk__draw_list_next, nb::rv_policy::reference);

    m.def("nk__draw_list_end", &nk__draw_list_end, nb::rv_policy::reference);

    m.def("nk_draw_list_path_clear", &nk_draw_list_path_clear);

    m.def("nk_draw_list_path_line_to", &nk_draw_list_path_line_to);

    m.def("nk_draw_list_path_arc_to_fast", &nk_draw_list_path_arc_to_fast);

    m.def("nk_draw_list_path_arc_to", &nk_draw_list_path_arc_to);

    m.def("nk_draw_list_path_rect_to", &nk_draw_list_path_rect_to);

    m.def("nk_draw_list_path_curve_to", &nk_draw_list_path_curve_to);

    m.def("nk_draw_list_path_fill", &nk_draw_list_path_fill);

    m.def("nk_draw_list_path_stroke", &nk_draw_list_path_stroke);

    m.def("nk_draw_list_stroke_line", &nk_draw_list_stroke_line);

    m.def("nk_draw_list_stroke_rect", &nk_draw_list_stroke_rect);

    m.def("nk_draw_list_stroke_triangle", &nk_draw_list_stroke_triangle);

    m.def("nk_draw_list_stroke_circle", &nk_draw_list_stroke_circle);

    m.def("nk_draw_list_stroke_curve", &nk_draw_list_stroke_curve);

    m.def("nk_draw_list_stroke_poly_line", &nk_draw_list_stroke_poly_line);

    m.def("nk_draw_list_fill_rect", &nk_draw_list_fill_rect);

    m.def("nk_draw_list_fill_rect_multi_color", &nk_draw_list_fill_rect_multi_color);

    m.def("nk_draw_list_fill_triangle", &nk_draw_list_fill_triangle);

    m.def("nk_draw_list_fill_circle", &nk_draw_list_fill_circle);

    m.def("nk_draw_list_fill_poly_convex", &nk_draw_list_fill_poly_convex);

    m.def("nk_draw_list_add_image", &nk_draw_list_add_image);

    m.def("nk_draw_list_add_text", &nk_draw_list_add_text);

    m.def("nk_style_item_color", &nk_style_item_color);

    m.def("nk_style_item_image", &nk_style_item_image);

    m.def("nk_style_item_nine_slice", &nk_style_item_nine_slice);

    m.def("nk_style_item_hide", &nk_style_item_hide);
