...
set(GLFW_BUILD_WIN32 ON CACHE INTERNAL "")
...
set(LUNASVG_LIB_TYPE STATIC CACHE STRING "" FORCE)


FetchContent_MakeAvailable(python_win_sdk lunasvg)
...
target_link_libraries(NPWindows PRIVATE
    nuklear_lib 
    glfw 
    OpenGL::GL   
    lunasvg
...
target_link_options(NPWindows PRIVATE "-static")
